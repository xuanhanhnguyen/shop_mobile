    ...
    <div class="callout-top callout-top-danger col-md-12">
        <form action="/admin/member/{{$member->id}}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text"
                       class="form-control" name="ten_kh" value="{{$member->ten_kh}}" aria-describedby="helpId" required>
                <input type="text"
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text"
                           class="form-control" name="email" value="{{$member->email}}" aria-describedby="helpId" placeholder="" required>
                </div>
                <div class="form-group col-md-6">
                    <label for="title">Điện thoại:</label>
                    <input type="text"
                           class="form-control" name="dien_thoai" value="{{$member->dien_thoai}}" aria-describedby="helpId" placeholder="" required>
                </div>
            </div>
            <div class="form-group">
                <label for="title">Địa chỉ:</label>
                <input type="text"
                       class="form-control" name="dia_chi" value="{{$member->dia_chi}}" aria-describedby="helpId" placeholder="" required>
            </div>
